...
public class FoursquareDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpinner.setMessage(getContext().getString(br.com.eduardo.nearby.R.string.fsqDialog_carregando));
	 ...
	 private void setUpTitle() {
	        ...
	        Drawable icon = getContext().getResources().getDrawable(R.drawable.arrow_down_float);
	    ...
	    private class TwitterWebViewClient extends WebViewClient {
	        ...
	        public boolean shouldOverrideUrlLoading(WebView view, String url) {
	        	Log.d(TAG, "URL de redicerionamento " + url);
